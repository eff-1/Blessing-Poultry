...
const ChristmasHero = ({ heroData: propHeroData }) => {
  ...
  const getIconComponent = (iconName) => {
    const icons = { Gift, Sparkles, ShoppingBag, Zap, Star, Heart };
  ...
  return (
    <div className="w-full bg-gradient-to-br from-emerald-50 via-white to-green-50 pt-20 md:pt-24 pb-4 md:pb-8 px-4">
      <div
        className="relative max-w-7xl mx-auto overflow-hidden rounded-3xl shadow-2xl min-h-[500px] md:min-h-[450px] lg:min-h-[480px]"
      ...
      >
        ...
        <div className="relative z-10 px-2 md:px-6 py-4 md:py-6">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-3 md:mb-4">
            <div className="mb-4 md:mb-0">
              <div className="inline-flex items-center gap-1.5 md:gap-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-3 py-1.5 md:px-6 md:py-3 rounded-full shadow-xl transform hover:scale-105 transition-all duration-300">
                <Gift className="w-3 h-3 md:w-5 md:h-5 animate-pulse" />
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
            ...
            <button
              onClick={() => scrollToSection('products')}
              className="group relative px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-base md:text-lg font-bold rounded-full shadow-xl hover:shadow-green-500/50 transform hover:scale-105 transition-all duration-300 overflow-hidden"
            >
              <span className="relative z-10 flex items-center justify-center gap-2">
                <Zap className="w-4 h-4 md:w-5 md:h-5 group-hover:animate-bounce" />
                {heroData.cta_secondary || 'Flash Deals'}
              </span>
